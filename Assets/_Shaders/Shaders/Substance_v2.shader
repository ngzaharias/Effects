...
#include "UnityCG.cginc"
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				colour.rgb = channelA.r * channelB.r * _DataA.w * _ColourBase;
				colour.rgb -= channelA.g * channelB.g * _DataB.w * _ColourAccent;
				colour.rgb += 0.2;

				// particle colours
				colour.rgb = lerp(colour, _ColourParticlesA * _DataC.w, channelC.b * _DataC.w);
				colour.rgb = lerp(colour, _ColourParticlesB * _DataD.w, channelD.a * _DataD.w);
